 ...
 * Use the [JetpackNavFourthFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class JetpackNavFourthFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvName.setText("Fourth Fragment")
        ...
        binding.btnNavigate.setOnClickListener {
          //  jetpackActivity.navController.navigate(R.id.jet)
        }
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            JetpackNavFourthFragment().apply {
